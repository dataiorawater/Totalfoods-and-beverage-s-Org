function doPost(e) {
  try {
    ...
    // Allow CORS headers by default for standard responses
    ...
    if (action === "getData") {
      ...
      // Delete old rows and append new ones
...
function doGet(e) {
  return response({ status: "ok", message: "GAS Backend is running successfully v2" });
}
